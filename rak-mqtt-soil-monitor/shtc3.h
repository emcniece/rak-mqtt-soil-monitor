...
void setup_shtc3(){
  Serial.println("SHTC3 setup... ");

  Wire.begin();
  Serial.print("  Init sensor. Result = "); // Most SHTC3 functions return a variable of the type "SHTC3_Status_TypeDef" to indicate the status of their execution
  ...
  if (g_shtc3.passIDcrc){                      // Whenever data is received the associated checksum is calculated and verified so you can be sure the data is true
    Serial.print("  ID Passed Checksum. ");      // The checksum pass indicators are: passIDcrc, passRHcrc, and passTcrc for the ID, RH, and T readings respectively
  ...
  Serial.println("SHTC3 setup complete");
}
